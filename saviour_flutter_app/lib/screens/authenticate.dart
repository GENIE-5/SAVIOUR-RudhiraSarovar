...
//Registeration of new user using email and password
  ...
  Future<bool> registerWithEmailAndPass(registerEmail, registerPassword,
      registerUsername, bloodGroup, pincode, age, mobileNumber) async {
    try {
      ...
      OurUser currentUserData = OurUser(
      ...
      DataBaseManager()
          .insertData(uid: userCredential.user!.uid, pincode: pincode);
